...
import { submitForm } from '../services/api'; // Your API call for form submission
...
interface FormData {
  ...
  file: File | null; // Updated to specify the type
  multipleFiles: File[]; // Updated to specify the type
  geolocation: string;
}
